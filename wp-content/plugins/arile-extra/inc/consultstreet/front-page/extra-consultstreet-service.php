...
$consultstreet_service_area_title = get_theme_mod('consultstreet_service_area_title', __('Our Services','arile-extra'));
$consultstreet_service_area_des = get_theme_mod('consultstreet_service_area_des', __('We provide the worlds best consulting related services to growth your business.','arile-extra'));
						...
						<?php } ?>
							...
							<?php if ( ! empty( $title ) ) : 
								if(empty($link)){ ?>
									...
									?>
									<h4 class="service-title"><a href="<?php echo $link; ?>" <?php if($open_new_tab!='no'){?>target="_blank" <?php }?> ><?php echo esc_html( $title ); ?></a></h5><?php
								}
							?>
							<?php endif; ?>
							<?php if ( ! empty( $text ) ) : ?>
			...
			{ ?>
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content text-center">
						...
						<h4 class="service-title"><a href="#"><?php esc_html_e('Corporate Finance','arile-extra'); ?></a></h4>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content text-center">
						...
						<h4 class="service-title"><a href="#"><?php esc_html_e('Consulting Service','arile-extra'); ?></a></h4>
						<p><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipisicing elit quos dolor quas molesty.','arile-extra'); ?></p>		
					</article>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content text-center">
						...
						<h4 class="service-title"><a href="#"><?php esc_html_e('Market Analysis','arile-extra'); ?></a></h4>
						<p><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipisicing elit quos dolor quas molesty.','arile-extra'); ?></p>
					</article>
				</div>	
			<?Php	
